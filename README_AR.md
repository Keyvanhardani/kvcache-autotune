...
### الخادم (RTX 4000 SFF Ada - 20GB VRAM)

| النموذج | الإنتاجية | TTFT | أفضل تكوين |
|---------|-----------|------|------------|
...
<p align="center">
  <img src="assets/server_throughput.png" alt="إنتاجية الخادم" width="800">
</p>

<p align="center">
  <img src="assets/server_dashboard.png" alt="لوحة معلومات الخادم" width="800">
</p>
